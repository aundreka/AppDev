...
class Level2Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final game = Level2Map();
    return Scaffold(
      body: GameWidget<Level2Map>(
        game: game,
        overlayBuilderMap: {
          'levelUp': (ctx, Level2Map game) {
          ...
          child: ConstrainedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color.fromARGB(255, 255, 72, 185), // cyan outer frame
                  width: 3,
                ),
                boxShadow: const [
